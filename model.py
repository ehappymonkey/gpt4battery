...
class RBNet(nn.Module):
    def __init__(self, configs):
        ...
        self.predict_linear_pre = nn.Linear(configs.seq_len, configs.pred_len + configs.seq_len)
        ...
        self.mainhead = nn.Linear(50, 1) # main task head
    ...
    def forward(self, x_enc, mask=None):
        dec_out, hidden_states = self.forecast(x_enc)
    ...
    def forecast(self, x_enc): # 输入维度是B, L, M
      ...
      #  print('after LLM:', dec_out.shape)
        ...
        return dec_out, last_hidden_states
